...
if strcmp(computer, 'MACI64')
    cd('/Volumes/mnl/Data/UURAF Projects/UURAF 2019 Structural Learning and Transfer/struct_learn_paper/Post_Step_2_RH_resub')
    files = dir('*train*');
else
    cd('cactus')
    files = dir('*train*');
...
for i = 1:length(files)
    ...
    % associated pValue.
    regData = [str2num(subID(12:14)) lm.ide.Coefficients.Estimate(2), lm.ide.Coefficients.pValue(2),...
    ...
    regDataEL = [str2num(subID(12:14)) 1 lm.ide_early.Coefficients.Estimate(2), lm.ide_early.Coefficients.pValue(2),...
        ...
        str2num(subID(12:14)) 2 lm.ide_late.Coefficients.Estimate(2) lm.ide_late.Coefficients.pValue(2),...
    ...
    if strcmp(computer,'MACI64') == 1
        ...
        cd('Z:\Data\UURAF Projects\UURAF 2019 Structural Learning and Transfer\struct_learn_paper') % PCs
    end
