...
if strcmp(str,'MACI64') == 1
    cd('/Volumes/mnl/Data/UURAF Projects/UURAF 2019 Structural Learning and Transfer/Raw_Data');
    fname = uigetfile('*train.zip');
    fname = fname(1:end);
else
    cd('Z:\Data\UURAF Projects\UURAF 2019 Structural Learning and Transfer\Raw_Data');
    fname = uigetfile('*train.zip');
    fname = fname(1:end);
end
...
% wrong_trial(exTrials) = 1; % Set wrong_trial during exposure trials to 1 so no data are processed during this phase.
...
%             figure('Position', [100 100 1680/2 1050/2]); %[bottom left corner coords X and Y, W, H]
            subplot(1,2,1)
...
if strcmp(str,'MACI64') == 1
    ...
    cd('Z:\Data\UURAF Projects\UURAF 2019 Structural Learning and Transfer\Post_Step_1');
end
...
message = ['All Kinematic analyses have been performed for this subject.'];
