...
if strcmp(str,'MACI64') == 1
    ...
    cd('Z:\Data\UURAF Projects\UURAF 2019 Structural Learning and Transfer\Post_Step_1_RH'); % Lab PCs
...
axis([-5 25 -15 15]); set(gca,'LineWidth',2,'XTick',[-5 10 25],'YTick',[-15 -10 0 10 15],'YTickLabel',[-15 -10 0 10 15],'FontName','Arial','FontSize',10); title([subID(7:10),' ','Late Post-Exposure'],'fontsize',11);
axis square
hold on
plot(sortData(1).TARGET_TABLE.X(1)+r_home*cos(ang),sortData(1).TARGET_TABLE.Y(1)+r_home*sin(ang),'Color',[255/255 117/255 56/255]) %home position
hold on
