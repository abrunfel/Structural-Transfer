...
function [fbrmse, fbrmse_c, fbrmse_down_st, fbrmse_up_st] = feedbackrmse(plotBool, cursorPosX, cursorPosY, indPeak, offset, numTrials, wrong_trial, upTrials, downTrials, exTrials, peTrials, subID)
...
for i=1:numTrials
    if wrong_trial(i)==0
        xx=cursorPosX{i,1}(indPeak(i):offset(i))*1000; % convert to mm; NOTE: This is now the 'feedback' version of RMSE (from index of peak velocity to movement offset)
