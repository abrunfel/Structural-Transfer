...
if strcmp(str,'MACI64') == 1
    ...
    cd('Z:\Data\UURAF Projects\UURAF 2019 Structural Learning and Transfer\Post_Step_2'); % Lab PCs
end
...
if strcmp(str,'MACI64') == 1
    cd('/Volumes/mnl/Data/UURAF Projects/UURAF 2019 Structural Learning and Transfer/Post_Step_3');
    dlmwrite('train_raw', ALL_subjects, '-append', 'delimiter', ',', 'precision','%.6f');
    cd('/Volumes/mnl/Data/UURAF Projects/UURAF 2019 Structural Learning and Transfer/Post_Step_2');
else
    cd(['Z:\Data\UURAF Projects\UURAF 2019 Structural Learning and Transfer\Post_Step_3']); % Lab PCs
    dlmwrite('train_raw', ALL_subjects, '-append', 'delimiter', ',', 'precision','%.6f');
    cd(['Z:\Data\UURAF Projects\UURAF 2019 Structural Learning and Transfer\Post_Step_2']); % Lab PCs
end
